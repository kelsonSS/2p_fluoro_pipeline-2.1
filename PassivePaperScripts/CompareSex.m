...
%% Correlations 
 ...
 Corr.YoungMF.SignalCorr = Compare2Anova(FRA_young_noise_F.CorrByAnimal.LCorr',...
FRA_young_noise_M.CorrByAnimal.LCorr',{'Female','Male'},{'Tones','20','10','0'},...
'SignalCorr-Cell') ;
                              
 Corr.YoungMF.NoiseCorr = 
                                                              
 Corr.YoungMF.SignalCorrAnimal =    
                              
 Corr.YoungMF.NoiseCorrAnimal =  CompareOldYoung(FRA_young_noise_F.CorrByAnimal.NCorrAnimal,...
                                  FRA_young_noise_M.CorrByAnimal.NCorrAnimal,'NoiseCorr-Animal',{'Female','Male'},...
                                  {'Tones','20','10','0'})
