function active = ClusterDiversityByAnimal(Clusters,expt_ids,to_plot)
...
if isstruct(Clusters)
  active = ClusterDiversityByAnimal(Clusters.Combined_Classes,Clusters.experiment_list,to_plot);
    return
