...
% This is a generic get function for all child classes.
switch nargin
    case 1
        % if property is specified, display all the fields if no output otherwise return them in varargout
        ...
        for cnt1 = order
            % if no output required, just display the fields. otherwise  put them as fields of output variable
    ...
    case 2
        % if single property is specified, display it or return its value based on argout
        fields = fieldnames(varargin{1});
