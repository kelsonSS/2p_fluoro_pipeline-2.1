function varargout = IOControlDigGate (HW,PumpAction,Duration,PumpName)
...
if isempty(pumpidx),
    ...
    warning('digital output channel ''',PumpName,''' not defined.');
    return;
end
t=[];
switch lower(PumpAction)
    case 'start';
        ev = struct('Note',['BEHAVIOR,DIGGATEON,',PumpName],'StartTime',...
            IOGetTimeStamp(HW));
    ...
    case {'stop',0};
        ...
        ev = struct('Note',['BEHAVIOR,DIGGATEOFF,',PumpName],'StartTime',...
